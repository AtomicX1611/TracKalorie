        ...
        const results = await MealModel.aggregate([
            ...
            { $unwind: '$items' },
            {
                $group: {
                    ...
                    vitaminD_mcg: { $sum: { $ifNull: ['$items.micros.vitaminD_mcg', 0] } },
                    vitaminE_mg: { $sum: { $ifNull: ['$items.micros.vitaminE_mg', 0] } },
                    vitaminK_mcg: { $sum: { $ifNull: ['$items.micros.vitaminK_mcg', 0] } },
                    thiamin_mg: { $sum: { $ifNull: ['$items.micros.thiamin_mg', 0] } },
                    riboflavin_mg: { $sum: { $ifNull: ['$items.micros.riboflavin_mg', 0] } },
                    niacin_mg: { $sum: { $ifNull: ['$items.micros.niacin_mg', 0] } },
                    vitaminB6_mg: { $sum: { $ifNull: ['$items.micros.vitaminB6_mg', 0] } },
                    vitaminB12_mcg: { $sum: { $ifNull: ['$items.micros.vitaminB12_mcg', 0] } },
                    folate_mcg: { $sum: { $ifNull: ['$items.micros.folate_mcg', 0] } },
                    calcium_mg: { $sum: { $ifNull: ['$items.micros.calcium_mg', 0] } },
                    iron_mg: { $sum: { $ifNull: ['$items.micros.iron_mg', 0] } },
                    magnesium_mg: { $sum: { $ifNull: ['$items.micros.magnesium_mg', 0] } },
                    potassium_mg: { $sum: { $ifNull: ['$items.micros.potassium_mg', 0] } },
                    zinc_mg: { $sum: { $ifNull: ['$items.micros.zinc_mg', 0] } },
                    selenium_mcg: { $sum: { $ifNull: ['$items.micros.selenium_mcg', 0] } },
